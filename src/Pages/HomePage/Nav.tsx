...
const Navbar: React.FC = () => {
  ...
  const getDashboardLink = () => {
    ...
    return {
      label: `${userData.role === "mentor" ? "Mentor" : "Mentee"} Dashboard`,
      href:
        userData.role === "mentor"
          ? "/mentor_dashboard/home"
          : "/mentee_dashboard/profile",
    };
  };
    ...
    <nav className="fixed w-full bg-white shadow-sm z-100">
      <div className="flex justify-between items-center p-4 md:px-8">
        ...
        <div className="hidden md:flex items-center space-x-4 md:space-x-8">
          ...
          {/* Only show dashboard link if user is authenticated and has a role */}
          {dashboardLink && (
            <>
        ...
        <div className="hidden md:flex items-center space-x-3">
          ...
          {/* Only show find mentor button if not authenticated or if user is a mentee */}
          {(!user || (userData?.role === "mentee")) && (
            <Link
              to="/explore-mentors"
